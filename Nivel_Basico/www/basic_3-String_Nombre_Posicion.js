...
const name = 'Miguel';
const surname1 = 'Induráin';
const surname2 = 'Larraya';

let fullName = `${surname1} ${surname2}, ${name} (${name[0]}${surname1[0]}${surname2[0]})`;

console.log(fullName);

const ultimaLetra = `${name[name.length-1].toUpperCase()}${surname1[surname1.length-1].toUpperCase()}${surname2[surname2.length-1].toUpperCase()}`;

console.log(ultimaLetra);

const position1000 = fullName[1000];

console.log(position1000);
