...
primeraParte = `${name.slice(0, name.length/2)}`

segundaParte = `${name.slice(name.length/2, name.length)}`

sinPrimerayUltimaLetra = name.slice(1, name.length-1)

console.log(primeraParte)

console.log(segundaParte)

console.log(sinPrimerayUltimaLetra)


// Asi hizo el profesor
