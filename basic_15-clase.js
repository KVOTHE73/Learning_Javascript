...
const inicial = 12450
const medio = 20200
const medioAlto = 35200
const alto = 60000
const irpfInicial = (12450 * 0.19)
const irpfMedio = irpfInicial + ((20200 - 12450) * 0.24)
const irpfMedioAlto = irpfMedio + ((35200 - 20200) * 0.3)
const irpfAlto = irpfMedioAlto + ((60000 - 35200) * 0.37)

console.log(irpfMedio);
