...
if (positionFirstHashtag != -1) {
    ...
    firstHashTag = tweet.slice(positionFirstHashtag, positionFirstHashtag + 
    DEFAULT_HASHTAG_LENGTH + 1);
    console.log(firstHashTag)
}

if (positionSecondHashTag != -1) {
    secondHashTag = tweet.slice(positionSecondHashTag, positionSecondHashTag + 
    DEFAULT_HASHTAG_LENGTH + 1);
